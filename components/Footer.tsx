...
const courses = [
  { href: "/courses/", label: "Qur'an Memorization" },
  { href: "/courses/", label: "Arabic Language" },
  { href: "/courses/", label: "Fiqh Studies" },
  { href: "/courses/", label: "Hadeeth Studies" },
  { href: "/courses/", label: "Seerah" },
]
...
export default function Footer() {
  return (
    <footer className="bg-primary text-white">
      {/* Islamic Divider */}
      <div className="h-1 bg-gradient-to-r from-soft via-accent to-soft" />
      ...
      <div className="section-padding max-w-7xl mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-5">
              Connecting Arabic to Your Deen. A premier Islamic educational
              institution dedicated to nurturing scholars and believers in
              Ibadan, Nigeria.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-5 text-soft">
              Quick Links
            </h3>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/50 text-xs">
            &copy; {new Date().getFullYear()} The Pen & Tongue Academy. All
            rights reserved.
          </p>
